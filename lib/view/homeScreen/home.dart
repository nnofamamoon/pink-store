    ...
    return GetBuilder<HomeController>(
      builder: (homecontroller) {
        ...
        Row(children: [
              ...
              SizedBox(width: 10,),
              GetBuilder<LoggedController>(
                builder: (locontroller) {
                  return Container(
...
//                      locontroller.logout();
//                      print('//////////');
//                      print(locontroller.log);
//                     }, icon: Icon(Icons.shopping_bag_rounded,size: 30,color: AppColor.primaryColor,)),);
//                 }
//               )
//                   ],),
//                   SizedBox(height: 20,),
...
//                           itemBuilder: (context,i){
//                             print('length');
// print(homecontroller.discountProduct.length);
// print(homecontroller.favorite.length);
//                               DiscountModel d=homecontroller.discountProduct[i];
//                               // FavoriteProductHome fav=homecontroller.favorite[i];
//                                  print( '${URL.imageUrl}'+'uploads/'+'${d.image}');
//                           return Padding(padding:EdgeInsets.symmetric(vertical: 15,horizontal:5) ,
